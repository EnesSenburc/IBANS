...
const AddIbanModal = ({ visible, onClose }) => {
    ...
    const handleSaveIban = async () => {
        ...
        try {
            ...
            const updatedIbanList = [newIbanEntry, ...parsedData];
            ...
            console.error('Error saving IBAN:', ex);
        }
    };
        ...
        <Modal animationType='fade' transparent={true} visible={visible} onRequestClose={onClose}>
            <View style={styles.modalBackdrop}>
                <View style={styles.modalContentContainer}>
                    <Text style={styles.modalHeaderText}>Yeni IBAN Ekle</Text>
                    ...
                    <View style={styles.buttonContainer}>
                        <TouchableOpacity style={styles.saveButtonContainer} onPress={handleSaveIban}>
